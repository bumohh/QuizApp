...
class Survey2ViewController: UIViewController {
    ...
    @IBOutlet weak var survey2Rate1: CosmosView!
    @IBOutlet weak var survey2Rate2: CosmosView!
    @IBOutlet weak var survey2Rate3: CosmosView!
    @IBOutlet weak var survey2Rate5: CosmosView!
    @IBOutlet weak var survey2Rate4: CosmosView!
    ...
    override func viewDidLoad() {
        ...
        do {
            //fetch data
            let request = Survey2.fetchRequest() as NSFetchRequest<Survey2>
        ...
        survey2Rate1.settings.fillMode = .half
        survey2Rate2.settings.fillMode = .half
        survey2Rate3.settings.fillMode = .half
        survey2Rate4.settings.fillMode = .half
        survey2Rate5.settings.fillMode = .half
        
        survey2Rate1.didFinishTouchingCosmos = {
            rate in
            self.rating1 = rate
            if rate <= 2.5 {
        ...
        survey2Rate2.didFinishTouchingCosmos = {
            rate2 in
            self.rating2 = rate2
            if rate2 <= 2.5 {
        ...
        survey2Rate3.didFinishTouchingCosmos = {
            rate3 in
            self.rating3 = rate3
            if rate3 <= 2.5 {
        ...
        survey2Rate4.didFinishTouchingCosmos = {
            rate4 in
            self.rating4 = rate4
            if rate4 <= 2.5 {
        ...
        survey2Rate5.didFinishTouchingCosmos = {
            rate5 in
            self.rating5 = rate5
            if rate5 <= 2.5 {
    ...
    @IBAction func Survey2Submit(_ sender: Any) {
