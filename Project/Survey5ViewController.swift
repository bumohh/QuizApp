...
class Survey5ViewController: UIViewController {
    let context = (UIApplication.shared.delegate as! AppDelegate).persistentContainer.viewContext
    
    var labelText : String = "Service \nSurvey"
    ...
    @IBOutlet weak var survey5Rate1: CosmosView!
    @IBOutlet weak var survey5Rate2: CosmosView!
    @IBOutlet weak var survey5Rate3: CosmosView!
    @IBOutlet weak var survey5Rate4: CosmosView!
    @IBOutlet weak var survey5Rate5: CosmosView!
    ...
    override func viewDidLoad() {
        ...
        do {
            //fetch data
            let request = Survey5.fetchRequest() as NSFetchRequest<Survey5>
        ...
        survey5Rate1.settings.fillMode = .half
        survey5Rate2.settings.fillMode = .half
        survey5Rate3.settings.fillMode = .half
        survey5Rate4.settings.fillMode = .half
        survey5Rate5.settings.fillMode = .half
        
        
        survey5Rate1.didFinishTouchingCosmos = {
            rate in
            self.rating1 = rate
        ...
        survey5Rate2.didFinishTouchingCosmos = {
            rate2 in
            self.rating2 = rate2
            if rate2 <= 2.5 {
        ...
        survey5Rate3.didFinishTouchingCosmos = {
            rate3 in
            self.rating3 = rate3
            if rate3 <= 2.5 {
        ...
        survey5Rate4.didFinishTouchingCosmos = {
            rate4 in
            self.rating4 = rate4
            if rate4 <= 2.5 {
        ...
        survey5Rate5.didFinishTouchingCosmos = {
            rate5 in
            self.rating5 = rate5
            if rate5 <= 2.5 {
    ...
    @IBAction func Survey5Submit(_ sender: Any) {
