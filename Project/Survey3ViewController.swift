...
class Survey3ViewController: UIViewController {
    ...
    @IBOutlet weak var survey3Rate1: CosmosView!
    @IBOutlet weak var survey3Rate2: CosmosView!
    @IBOutlet weak var survey3Rate3: CosmosView!
    @IBOutlet weak var survey3Rate4: CosmosView!
    @IBOutlet weak var survey3Rate5: CosmosView!
        ...
        override func viewDidLoad() {
            ...
            do {
                //fetch data
                let request = Survey3.fetchRequest() as NSFetchRequest<Survey3>
            ...
            survey3Rate1.settings.fillMode = .half
            survey3Rate2.settings.fillMode = .half
            survey3Rate3.settings.fillMode = .half
            survey3Rate4.settings.fillMode = .half
            survey3Rate5.settings.fillMode = .half
            
            survey3Rate1.didFinishTouchingCosmos = {
                rate in
                self.rating1 = rate
            ...
            survey3Rate2.didFinishTouchingCosmos = {
                rate2 in
                self.rating2 = rate2
                if rate2 <= 2.5 {
            ...
            survey3Rate3.didFinishTouchingCosmos = {
                rate3 in
                self.rating3 = rate3
                if rate3 <= 2.5 {
            ...
            survey3Rate4.didFinishTouchingCosmos = {
                rate4 in
                self.rating4 = rate4
                if rate4 <= 2.5 {
            ...
            survey3Rate5.didFinishTouchingCosmos = {
                rate5 in
                self.rating5 = rate5
                if rate5 <= 2.5 {
    ...
    @IBAction func Survey3Submit(_ sender: Any) {
