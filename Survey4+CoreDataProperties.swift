//
//  Survey4+CoreDataProperties.swift
//  Project
//
...
extension Survey4 {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<Survey4> {
        return NSFetchRequest<Survey4>(entityName: "Survey4")
    }
...
extension Survey4 : Identifiable {
